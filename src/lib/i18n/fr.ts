...
export const fr: Translations = {
  ...
  hero: {
    ...
    subtitle:
      "Eden Plaza Nettoyage — Votre expert en propreté professionnelle à Casablanca. Fiable, efficace, imbattable.",
    ctaPrimary: { label: "Découvrir nos services" },
    ctaSecondary: { label: "Demander un Devis" },
  },
  services: [
    {
    ...
    },
    {
      ...
      targets:
        "Hôtels, halls d'immeubles, villas, bureaux, showrooms, espaces de luxe",
      coverage:
        "Casablanca, Rabat, Mohammedia, El Jadida, Marrakech, Fès, Tanger, Agadir… et toutes les villes du Maroc sur demande.",
      whyUs: [
    ...
    },
    {
      ...
      faqs: [
        {
          question:
            "Les produits utilisés sont-ils dangereux pour les enfants ou animaux ?",
          answer:
  ...
  usps: [
    ...
    },
    {
      ...
      description: "Utilisation de produits sûrs et respectueux de l'environnement.",
    },
    {
    ...
    },
    {
      ...
      description: "Nous intervenons selon vos disponibilités, même le week-end.",
    },
  ],
  about: {
    label: "À Propos",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Oui, nous intervenons 7 jours sur 7 selon vos disponibilités.",
    },
    {
  ...
  ui: {
    ...
    servicesTitle: "Des services professionnels adaptés à tous vos besoins",
    whyChooseUsLabel: "Pourquoi Nous Choisir",
    whyChooseUsTitle: "L'excellence au service de votre propreté",
    ...
    footerServicesHeading: "Nos Services",
    ...
    formMessage: "Message *",
    formPlaceholderName: "Votre nom complet",
    formPlaceholderEmail: "votre@email.com",
    formPlaceholderPhone: "+212 6XX XXX XXX",
    formPlaceholderService: "Sélectionnez un service",
    formPlaceholderMessage: "Décrivez votre besoin...",
    ...
    prevServices: "Services précédents",
    nextServices: "Services suivants",
    scrollDown: "Défiler vers le bas",
    // Service detail page
    serviceBadge: "Service professionnel",
    prestationsHeading: "Nos prestations",
    targetsHeading: "Pour les professionnels",
    coverageHeading: "Zones couvertes",
    whyUsHeading: "Pourquoi choisir Eden Plaza ?",
    ctaSidebarTitle: "Besoin de ce service ?",
    ctaSidebarBodyShort: "Contactez-nous pour un devis gratuit et personnalisé.",
    ctaSidebarBodyLong: "Contactez-nous dès maintenant pour un devis gratuit et personnalisé.",
    callButton: "Appeler",
    callButtonLong: "Appeler maintenant",
    otherServicesHeading: "Nos autres services",
    requestQuoteShort: "Demander un Devis",
    requestQuoteButton: "Demander un Devis Gratuit",
    backToHome: "Retour à l'accueil",
    serviceNotFound: "Service introuvable",
    serviceNotFoundBody: "Le service demandé n'existe pas.",
    ctaBottomBody: "Contactez Eden Plaza Nettoyage pour un devis gratuit. Notre équipe vous répondra dans les plus brefs délais.",
    // Blog
    blogLabel: "Blog & Actualités",
    blogTitle: "Nos Articles et Conseils",
    blogSubtitle: "Guides pratiques, conseils d'experts et actualités du secteur du nettoyage professionnel au Maroc.",
    blogReadMore: "Lire l'article",
    blogMinRead: "min de lecture",
    blogAllCategories: "Tous les articles",
    blogCategoryGuide: "Guides",
    blogCategoryConseil: "Conseils",
    blogCategoryActualite: "Actualités",
    blogPublishedOn: "Publié le",
    blogRelatedServices: "Services associés",
    blogRelatedPosts: "Articles similaires",
    blogShareArticle: "Partager cet article",
    blogBackToBlog: "Retour au blog",
    footerBlogHeading: "Blog",
  },
};
