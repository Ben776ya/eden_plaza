...
export default function ServicePageClient({ slug }: { slug: string }) {
  ...
  const serviceSchema = {
    ...
    url: `https://www.edenplazanettoyage.ma/services/${slug}`,
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Services", item: "https://www.edenplazanettoyage.ma/#services" },
              ...
              <div className="lg:col-span-2 space-y-8 sm:space-y-12">
                ...
                <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    {service.prestations.map((item: string, i: number) => (
                      <motion.div
                        key={i}
