        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="mt-6 rounded-xl overflow-hidden border" style={{ borderColor: "var(--color-border)" }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3323.846!2d-7.5898!3d33.5731!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDM0JzIzLjIiTiA3wrAzNSczNS4zIlc!5e0!3m2!1sfr!2sma!4v1"
                width="100%"
                height="200"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Eden Plaza Nettoyage - Casablanca"
              />
            </div>
          </motion.div>
