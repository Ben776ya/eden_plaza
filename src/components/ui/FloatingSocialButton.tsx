...
const socials = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/edenplaza.nettoyage",
    color: "#E4405F",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/edenplaza.nettoyage",
    color: "#1877F2",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/edenplaza-nettoyage",
    color: "#0A66C2",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@edenplaza-nettoyage",
    color: "#FF0000",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      {socials.map((social, i) => {
        ...
        return (
          <a
            ...
            className="absolute flex h-11 w-11 items-center justify-center rounded-full text-white shadow-lg transition-all duration-300"
            style={{
